...
class PromotionOfferService
{
    ...
    private function configurationFor(Promotion $promotion): ?array
    {
        ...
        return match (true) {
            $normalizedPath === '/hotels' || Str::startsWith($normalizedPath, '/hotels/') => [
                ...
                'summary' => 'The promotion now resolves to real discounted rooms instead of dropping the customer onto a generic hotel listing.',
            ...
            in_array($normalizedPath, ['/ferries', '/ferrytickets'], true) => [
                ...
                'summary' => 'Each listed crossing is bookable from this page at the promotion rate instead of bouncing customers to a broken route.',
            ...
            $normalizedPath === '/beach-events' => [
                ...
                'summary' => 'Each event below carries the promotion price all the way through demo checkout and confirmation.',
        ...
        return $this->hotelRooms($config)
            ->map(fn (Room $room) => [
                ...
                'form' => [
                    ...
                    'mode' => 'date-range',
                    'rulesHint' => 'The reduced nightly rate carries through to the demo checkout screen.',
    ...
    private function specificHotelConfiguration(string $normalizedPath): ?array
    {
        ...
        return [
            'offer_type' => 'hotel',
            'kicker' => 'Promotion Ledger',
            'lede' => $hotel->name.' now opens through a dedicated promotion page with discounted bookable rooms instead of redirecting to the plain hotel profile.',
