...
class HorrorAtlasService
{
    ...
    private function mapRide(Ride $ride, ?array $bounds): array
    {
        ...
        return [
            ...
            'zoneLabel' => 'Grounds',
            'zoneName' => $ride->location ?? $ride->island->name ?? 'Horror Island',
    ...
    private function mapGame(Game $game, ?array $bounds): array
    {
        ...
        return [
            ...
            'zoneLabel' => 'Grounds',
            'zoneName' => $game->location ?? $game->island->name ?? 'Horror Island',
    ...
    private function mapBeachEvent(BeachEvent $event, ?array $bounds): array
    {
        ...
        return [
            ...
            'zoneLabel' => 'Shore',
            'zoneName' => $event->location ?? $event->island->name ?? 'Picnic Island',
    ...
    private function mapFerry(Ferry $ferry, ?array $bounds): array
    {
        ...
        return [
            ...
            'zoneName' => $ferry->location ?? $ferry->island->name ?? 'Horror Island',
