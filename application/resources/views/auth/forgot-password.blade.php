...
<main class="max-w-lg mx-auto bg-gray-800 p-6 rounded shadow border border-gray-700">
    <h1 class="text-3xl font-bold mb-6 horror-font text-center">Reset Password</h1>
    ...
    <p class="mt-4 text-sm text-center text-gray-300">
        Remembered your password? <a href="{{ route('login') }}" class="text-red-400 hover:text-red-300">Log in</a>
    </p>
</main>
@endsection
